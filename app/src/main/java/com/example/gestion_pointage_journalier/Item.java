...
public class Item extends Fragment  implements View.OnClickListener{
    ...
    private static final String ARG_PARAM1 = "cleftext";
    ...
    public static Item newInstance(String param1) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String employe = getArguments().getString(ARG_PARAM1);

        // Inflate the layout for this fragment
        this.view = inflater.inflate(R.layout.fragment_item, container, false);

        View empView = this.view.findViewWithTag("tag_emp");

        if (empView != null) ((TextView) empView).setText(employe);

        View actionView = view.findViewWithTag("tag_bt_delete");
